...
public class ModBlocks
{
									...
									Class<? extends ItemBlock> itemClass) throws Exception
	{
		try
		{
			...
			LogHelper.info(b.toString());
			//register itemblock
			if (itemClass != null)
			{
				Constructor<? extends ItemBlock> ct = itemClass.getDeclaredConstructor(Block.class);
                ct.newInstance(b).setRegistryName(b.getRegistryName());
			}   //TODO 媽的你這個架構怎麽註冊ItemBlock？
			else
			{
